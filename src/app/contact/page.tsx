...
export default function Contact() {
  ...
  const openKingdomBuilderForm = () => {
    ...
    track('Kingdom Builder Form Opened', { location: 'contact' });
    setIsFormOpen(true);
  };
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-12 border border-gray-200">
              ...
              >
                ...
                <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                  We&apos;re preparing comprehensive ways for you to connect with the 605 Wells team. 
                  Soon you&apos;ll find contact information, ministry inquiries, prayer requests, 
                  and multiple ways to get involved in this transformational Kingdom work.
                </p>
