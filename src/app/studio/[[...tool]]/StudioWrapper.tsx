...
// Ministry Type Schema
const ministryTypeSchema = defineType({
  name: 'ministryType',
  title: 'Ministry Type',
  type: 'document',
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) =>
        Rule.custom((price, context) => {
          const costType = (context.document as { costType?: string })?.costType;
...
// Team Member Schema
const teamMemberSchema = defineType({
  name: 'teamMember',
  title: 'Team Member',
  type: 'document',
  fields: [
...
const config = defineConfig({
  ...
  schema: {
    types: [eventSchema, pastEventSchema, livestreamAccessSchema, eventRegistrationSchema, ministryCategorySchema, volunteerSchema, ministrySessionRequestSchema, ministryTypeSchema, teamMemberSchema],
  },
})
