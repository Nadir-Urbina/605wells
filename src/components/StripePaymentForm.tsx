  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <div 
          className="p-4 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500"
          role="group"
          aria-labelledby="card-element-label"
          aria-describedby="card-security-info"
        >
          <CardElement 
            options={{
              ...cardElementOptions,
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4" id="card-security-info">
